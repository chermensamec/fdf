...
s_struct *create_win(void)
{
	...
	data->window->win_height = 1080;
	data->window->win_width = 1920;
	data->window->mlx = mlx_init();
	data->window->mlx_win = mlx_new_window(data->window->mlx, data->window->win_width, data->window->win_height, "Hello world!");
